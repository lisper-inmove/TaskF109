...
class ByteStreamProtocol:
    ...
    def pack(self, data: Any) -> bytes:
        ...
        if isinstance(data, str):
            ...
            data_bytes = json.dumps(data, ensure_ascii=False).encode(self.encoding)
    ...
    def unpack(self, data: bytes) -> Optional[Tuple[Any, bytes]]:
        ...
        # 提取数据部分
        data_bytes = self.buffer[self.header_size:self.header_size + data_length]
    ...
    def create_response(self, success: bool, message: str = "", data: Any = None) -> Dict:
        """
        创建标准响应
